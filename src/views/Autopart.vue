    ...
    <section class="py-12 sm:py-16"> 
        <div class="container mx-auto px-4">
            <div v-if="autopartsStore.loading">
                <div className="animate-pulse h-4 bg-gray-300 rounded mb-6 w-2/3"></div>
            ...
            <div v-else>
                ...
                <div class="grid grid-cols-1 gap-12 mt-8 lg:mt-12 lg:grid-cols-5 lg:gap-16 lg:col-gap-12 xl:col-gap-16">
                    <div class="lg:col-span-3 lg:row-end-1">
                        <div>
                            <div class="relative mb-6 lg:mb-10 lg:h-2/4">
                                <img class="object-cover w-full lg:h-full rounded-2xl" :src="autopartsStore.currentImage?.url" alt="Auto Global">
                            </div>
