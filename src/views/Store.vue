<script>
    ...
    import { useAutopartsStore } from '../store'
    ...
    export default {
        ...
        methods: {
            getAll(page) {
                ...
                .then((response) => {
                    ...
                    const store = useAutopartsStore()
                    store.autoparts = this.autoparts
                    store.pagination = this.pagination
            ...
            getMakes() {
                ...
                .then((response) => {
                    ...
                    const store = useAutopartsStore()
                    store.lists.makes = this.lists.makes
            ...
            getModels() {
                ...
                .then((response) => {
                    ...
                    const store = useAutopartsStore()
                    store.lists.models = this.lists.models
            ...
            getCategories() {
                ...
                .then((response) => {
                    ...
                    const store = useAutopartsStore()
                    store.lists.categories = this.lists.categories
        ...
        mounted() {
            ...
            if (store.lists.makes.length == 0) {
                this.getMakes()
            } else {
                this.lists.makes = store.lists.makes
            }

            if (store.lists.models.length == 0) {
                this.getModels()
            } else {
                this.lists.models = store.lists.models
            }

            if (store.lists.categories.length == 0) {
                this.getCategories()
            } else {
                this.lists.categories = store.lists.categories
            }
            
            if (store.autoparts.length == 0) {
                this.getAll(1)
            } else {
                this.autoparts = store.autoparts
